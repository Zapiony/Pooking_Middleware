...
{
    private readonly IServicioGrpcClient _servicioClient;
        ...
        CancellationToken ct = default)
    {
        ...
        try
        {
            ...
            var resultado = await _servicioClient.ObtenerServicioPorGuidAsync(guidServicio, ct);
        ...
        CancellationToken ct = default)
    {
        ...
        try
        {
            ...
            var resultado = await _authClient.ObtenerUsuarioPorGuidAsync(guidUsuario, ct);
        ...
        CancellationToken ct = default)
    {
        ...
        try
        {
            ...
            return await _servicioClient.ValidarDisponibilidadAsync(guidServicio, fechaInicio, fechaFin, ct);
        }
        catch (Exception ex) when (ex is not MiddlewareException)
        {
            _logger.LogError(ex,
